...
const testimonials = [
  ...
  },
  {
    ...
    quote: 'Antes no sabía ni sumar, ahora soy el mejor arquitecto del mundo gracias a Studymind, ahora estoy postulando a la NASA para hacer casas en Saturno',
    rating: 5,
  ...
  },
  {
    ...
    quote: 'Gracias a las certificaciones de Studymind conseguí mi primer trabajo en una consultora internacional antes de egresar. Los empleadores valoran mucho la preparación de nivel europeo.',
    rating: 5,
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonios" ref={ref} className="py-20 md:py-32 bg-surface-50 relative overflow-hidden">
      <div className="absolute top-1/4 left-0 w-72 h-72 bg-primary-200/15 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-accent-200/15 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-500/10 text-rose-600 text-sm font-semibold mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 md:p-7 border border-surface-100 card-hover relative group"
            >
              {/* Quote icon */}
              ...
              {/* Quote */}
              <p className="text-sm md:text-base text-surface-600 leading-relaxed mb-5">
                "{t.quote}"
              </p>

              {/* Result Badge */}
              <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold mb-5">
                ✨ {t.result}
              </div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-surface-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-surface-500">{t.role} · {t.location}</p>
                </div>
              </div>
            </motion.div>
          ))}

...
export default function MathPractice() {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {mathCategories.map((cat, i) => (
              <motion.button
                ...
                className="group text-left p-5 rounded-2xl bg-white border border-surface-100 hover:border-primary-200 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
  ...
  if (view === 'results') {
    ...
    const getMessage = () => {
      if (percentage >= 90) return { emoji: '🏆', text: '¡Excelente! Dominas este tema.', color: 'text-emerald-600' };
      if (percentage >= 70) return { emoji: '🌟', text: '¡Muy bien! Estás en buen camino.', color: 'text-blue-600' };
      if (percentage >= 50) return { emoji: '💪', text: 'Buen esfuerzo. Sigue practicando.', color: 'text-amber-600' };
      return { emoji: '📚', text: 'No te rindas. Repasa y vuelve a intentarlo.', color: 'text-rose-600' };
    };
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 pt-24 pb-16">
        <div className="max-w-2xl mx-auto px-4">
          <motion.div
            ...
            className="bg-white rounded-3xl shadow-xl border border-surface-100 p-8 md:p-12 text-center"
          >
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 pt-24 pb-16">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <div className="bg-white rounded-3xl shadow-xl border border-surface-100 p-12">
            <div className="text-5xl mb-4">🔍</div>
            <h2 className="text-2xl font-bold text-surface-900 mb-2">No hay preguntas</h2>
            <p className="text-surface-500 mb-6">No se encontraron preguntas con los filtros seleccionados.</p>
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <button
            ...
            className="flex items-center gap-2 text-sm text-surface-600 hover:text-primary-600 transition-colors font-medium"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-medium text-surface-600 bg-white border border-surface-200 rounded-lg px-3 py-1.5 hover:border-primary-300 transition-colors"
              >
              ...
              <AnimatePresence>
                {showDiffFilter && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -5 }}
                    className="absolute right-0 top-full mt-1 bg-white rounded-xl shadow-xl border border-surface-100 py-1 z-20 min-w-[140px]"
                  >
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        {selectedAnswer === currentQuestion?.correctIndex ? (
                          <>
                            ...
                            <span className="font-bold text-emerald-800">¡Correcto!</span>
                          </>
                        ) : (
                          <>

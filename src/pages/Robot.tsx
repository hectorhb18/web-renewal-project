...
const specs = [
  ...
  { icon: Wifi, title: 'Sync con la app', desc: 'Se conecta con Studymind cuando hay señal y respalda el progreso en la nube.' },
...
const pros = [
  ...
  'Progreso sincronizado con la plataforma Studymind cuando hay conexión.',
...
const steps = [
  ...
  { n: '04', title: 'Sync con Studymind', desc: 'Cada vez que hay señal, el progreso sube a la app y los padres/docentes pueden verlo.' },
];

...
import {
  ...
  Play, BarChart3, CheckCircle2, Sparkles
} from 'lucide-react';
...
export default function Cursos() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface-50 via-white to-accent-50/30 pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-6 mt-6 text-sm text-surface-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filtered.map((course, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl border border-surface-100 overflow-hidden card-hover group"
            >
              {/* Course header */}
              <div className={`bg-gradient-to-r ${course.gradient} p-6 text-white relative overflow-hidden`}>
                <div className="absolute top-4 right-4 text-5xl opacity-20 font-bold">{course.icon}</div>

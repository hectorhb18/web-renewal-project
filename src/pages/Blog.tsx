...
import { ArrowLeft, ArrowUpRight, Clock, User, Tag } from 'lucide-react';

const posts = [
  {
    title: 'Cómo Studymind está cerrando la brecha educativa en el Perú',
  ...
  },
  {
    ...
    excerpt: 'Un estudiante de zona rural que usó Studymind para prepararse y obtener una beca completa en una de las mejores universidades del mundo.',
    category: 'Historias',
    author: 'Ana García',
    date: '20 Dic 2025',
    readTime: '5 min',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-surface-900 tracking-tight">
            Blog <span className="text-gradient">Studymind</span>
          </h1>

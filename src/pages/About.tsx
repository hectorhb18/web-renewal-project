...
const milestones = [
  { year: 'FASE 1', event: 'Identificación del problema sobre el acceso a información academica', icon: '🚀' },
  { year: 'FASE 2', event: 'Lanzamiento de la plataforma con 100 cursos iniciales', icon: '📚' },
  { year: '2023', event: '5,000 estudiantes activos en los primeros 6 meses', icon: '🎉' },
  { year: '2024', event: 'Alianza con universidades europeas para contenido exclusivo', icon: '🤝' },
  { year: '2024', event: 'Lanzamiento del motor de IA personalizada', icon: '🤖' },
  { year: '2025', event: '25,000 estudiantes activos en todo el Perú', icon: '🇵🇪' },
  { year: '2025', event: 'Primer estudiante becado en Oxford gracias a Studymind', icon: '🏆' },
  { year: '2026', event: 'Expansión a Colombia, Ecuador y Bolivia', icon: '🌎' },
];
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="mt-6 text-lg md:text-xl text-surface-600 max-w-3xl mx-auto leading-relaxed">
              ...
              Studymind existe para hacer eso una realidad.
            </p>
          </motion.div>
          ...
          <div className="relative">
            ...
            {milestones.map((m, i) => (
              ...
              >
                ...
                <div className="relative z-10 w-12 h-12 rounded-full bg-white border-2 border-primary-200 flex items-center justify-center text-xl flex-shrink-0 shadow-sm">
                  {m.icon}
                </div>

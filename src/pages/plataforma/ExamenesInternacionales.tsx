...
import { ChevronRight, CheckCircle2, Globe, Timer, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-surface-900 dark:text-white flex items-center gap-2">
          <Globe className="w-6 h-6 text-primary-500" /> Exámenes Internacionales
        </h1>
        <p className="text-surface-500 text-sm mt-1">
          Prepárate para el SAT y el TOEFL con bancos de preguntas, simulacros cronometrados y feedback de IA.
        </p>
      </div>
